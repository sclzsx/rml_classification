...
from networks.resnet import resnet50_11, resnet34_11
...
def train():
   ...
   elif cfgs.model == 'VGG16':
       model = VGG('VGG16', num_classes=cfgs.num_classes, batch_size=cfgs.batch_size)
   elif cfgs.model == 'Resnet34':
       model = resnet34_11()
